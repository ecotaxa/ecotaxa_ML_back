...
class PredictionBO(object):
        ...
        for obj_id, list_classifs, list_scores in zip(
            ...
            for pred_classif, pred_score in preds_for_object:
                preds_for_bulk.append(
                    {
                        Prediction.training_id.name: training_id,  # type: ignore
                        Prediction.object_id.name: obj_id,  # type: ignore
                        Prediction.classif_id.name: pred_classif,  # type: ignore
                        Prediction.score.name: pred_score,  # type: ignore
                    }  # type: ignore
                )
    ...
    def historize_predictions(self) -> PredictionBO:
        ...
        histo_qry = PredictionHisto.__table__.insert().from_select(
            [
                Prediction.training_id.name,   # type: ignore
                Prediction.object_id.name,  # type: ignore
                Prediction.classif_id.name,  # type: ignore
                Prediction.score.name,  # type: ignore
            ],
            here_sel,
        )
